...
module.exports = function (source) {
  ...
  var queryOptions = (0, _parseQueryString2.default)(webpack.query);
  var queryOptionResources = queryOptions.resources && queryOptions.resources.split(',');
  var resourcesLocation = (0, _parseResources2.default)(queryOptionResources || webpack.options.sassResources);
